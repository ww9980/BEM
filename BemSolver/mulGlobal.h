...
/*#define CALCORE(NUM, TYPE) kcalloc((unsigned)(NUM)*sizeof(TYPE)+4)*/
#define CALCORE(NUM, TYPE) kcalloc2((unsigned)(NUM)*sizeof(TYPE))

/*#define MALCORE(NUM) malloc((unsigned)(NUM))*/
/*#define MALCORE ualloc*/
/*#define MALCORE(NUM) kmalloc((unsigned)(NUM)+4)*/
#define MALCORE(NUM) kcalloc2((unsigned)(NUM))
